...
- Requirements: `docs/reqstream/ots/clang.yaml`, `docs/reqstream/ots/mono-cecil.yaml`,
  `docs/reqstream/ots/dema-consulting-test-results.yaml`, `docs/reqstream/ots/cpp-ast-net.yaml`
- Design: `docs/design/ots/clang.md`, `docs/design/ots/mono-cecil.md`,
  `docs/design/ots/dema-consulting-test-results.md`, `docs/design/ots/cpp-ast-net.md`
- Verification: `docs/verification/ots/clang.md`, `docs/verification/ots/mono-cecil.md`,
  `docs/verification/ots/dema-consulting-test-results.md`, `docs/verification/ots/cpp-ast-net.md`
