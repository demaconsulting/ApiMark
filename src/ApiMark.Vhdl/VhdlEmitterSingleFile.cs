...
internal sealed class VhdlEmitterSingleFile
{
    ...
    /// <summary>
    ///     Emits the heading, summary, generics, ports, and architectures for a single VHDL
    ///     entity into the shared single-file writer.
    /// </summary>
    ...
    /// </param>
    /// <param name="depth">Base heading depth for the library root; entity heading uses depth+2.</param>
    ...
    /// <summary>
    ///     Emits the heading, summary, types, constants, components, and subprograms for a
    ///     single VHDL package into the shared single-file writer.
    /// </summary>
    /// <param name="writer">Markdown writer to emit into.</param>
    ...
    /// <summary>
    ///     Emits a single subprogram sub-section within a package section, including summary,
    ///     optional details, parameters table, return type, and signature.
    /// </summary>
    /// <param name="writer">Markdown writer to emit into.</param>
    /// <param name="s">The subprogram declaration to emit.</param>
    /// <param name="depth">Base heading depth for the library root; subprogram heading uses depth+3.</param>
    private static void EmitSubprogramSection(IMarkdownWriter writer, VhdlSubprogramDecl s, int depth)
    {
